...
# ============================================================
#  HTML GENERATOR  — "studentski" dizajn
#  Čist, tabelarni, svjetla tema, bez efekta "AI alata"
# ============================================================
...
def generiraj_html(domen, ip, whois_pod, dns_pod, ssl_pod,
  ...
  <section id="{id_}" class="blok">
    ...
    if "greska" in ssl_pod:
        ...
        redovi += red("Status certifikata", f'<span class="status-pill {status_css}">{status_txt}</span>')
    ...
    if subs:
        ...
        sub_html += '<p class="napomena prazno">Nijesu pronađeni subdomeni.</p>'
...
<main>
  ...
  {odjeljak("ssl",      "03 · SSL/TLS certifikat",              ssl_html)}
...
print("[3/6] Skeniram SSL/TLS certifikat...")
